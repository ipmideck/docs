...
These all sit in the [data directory](/configuration#where-config-lives): `/data` on Docker
...
- [Configuration](/configuration): where the data directory lives and what `config.yaml` holds.
- [Updating ipmideck](/updating): your data survives an upgrade.
- [Security](/security): how credentials are encrypted at rest.
