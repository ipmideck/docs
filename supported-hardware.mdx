...
|--------|--------|-------------|-------|
| Dell PowerEdge / iDRAC | Supported / tested | [Dell iDRAC guide](/enable-ipmi/dell-idrac) | IPMI 2.0 — fully supported and tested. |
| Supermicro | Experimental | [Supermicro guide](/enable-ipmi/supermicro) | IPMI 2.0 — works, not yet exhaustively tested. |
| HPE iLO | Planned | [HPE iLO guide](/enable-ipmi/hpe-ilo) | IPMI 2.0 — on the roadmap. |
| Lenovo XCC | Planned | [Lenovo XCC guide](/enable-ipmi/lenovo-xcc) | IPMI 2.0 — on the roadmap. |
| IBM IMM | Planned | [IBM IMM guide](/enable-ipmi/ibm-imm) | IPMI 2.0 — on the roadmap. |
